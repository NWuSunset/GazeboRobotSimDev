...
#include <gz/msg/laserscan.pb.h>
#include <gz/transport/Node.hh>

std::string topic_pub = "/cmd_vel"; //topic to puublish to
...
void cb(const gz::msgs::LaserScan &_msg) {
    ...
    if (allMore) //if all bigger than one (rays bigger than 1.0, robot move forward)
    {
...
int main(int argc, char **argv) {
    ...
    //subscribe to topic by registering callback
